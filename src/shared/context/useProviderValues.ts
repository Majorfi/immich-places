...
export function useViewValue(input: TViewContextValue): TViewContextValue {
	return useMemo<TViewContextValue>(
		() => ({
			...
			selectFolderAction: input.selectFolderAction,
			selectedTagID: input.selectedTagID,
			selectTagAction: input.selectTagAction,
		...
		[
			...
			input.selectFolderAction,
			input.selectedTagID,
			input.selectTagAction,
			input.startDate,
			input.endDate,
...
export function useCatalogValue(input: TCatalogContextValue): TCatalogContextValue {
	return useMemo<TCatalogContextValue>(
		() => ({
			...
			isLoadingFolders: input.isLoadingFolders,
			foldersError: input.foldersError,
			loadFolderTreeAction: input.loadFolderTreeAction,
			assets: input.assets,
			total: input.total,
		...
		[
			...
			input.folderTree,
			input.isLoadingFolders,
			input.foldersError,
			input.loadFolderTreeAction,
			input.assets,
			input.total,
			input.currentPage,
